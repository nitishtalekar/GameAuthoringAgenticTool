...
**Does:** Picks one win recipe, one lose recipe, one structure/layout recipe, and zero or more patch recipes from the predefined library. The win and lose rercipeis must go hand in hand in their justification and should not contradict easch other.
